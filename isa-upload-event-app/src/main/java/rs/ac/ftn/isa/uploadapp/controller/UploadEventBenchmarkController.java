package rs.ac.ftn.isa.uploadapp.controller;

import org.springframework.http.MediaType;
import org.springframework.web.bind.annotation.*;
import rs.ac.ftn.isa.uploadapp.dto.UploadEventBenchmarkResult;
import rs.ac.ftn.isa.uploadapp.service.UploadEventBenchmarkService;
...
public class UploadEventBenchmarkController {
     ...
     * Na bar 50 poruka. Opcioni parametar: count (podrazumevano 50).
     */
