...
INSERT INTO video_posts (id, owner_id, title, description, location, thumbnail_path, video_path, created_at) VALUES (1, 1, 'Cocomelon Theme | BEGINNER PIANO TUTORIAL + SHEET MUSIC by Betacustic', 'In this piano tutorial you can learn HOW TO PLAY "Cocomelon Theme" by Cocomelon, BEGINNER version', 'Novi Sad', 'uploads\\thumbnails\\1.png', 'uploads\\videos\\1.mp4', '2026-01-03 14:58:38.322');
INSERT INTO video_posts (id, owner_id, title, description, location, thumbnail_path, video_path, created_at) VALUES (2, 1, 'Woodstock Kids Accordion', 'This colorful accordion from the makers of Woodstock Chimes comes with playing instructions and 8 easy-to-play songs. ', 'Novi Sad', 'uploads\\thumbnails\\2.png', 'uploads\\videos\\2.mp4', '2026-01-03 14:59:20.521');
INSERT INTO video_posts (id, owner_id, title, description, location, thumbnail_path, video_path, created_at) VALUES (3, 1, 'Snimak neba', 'Deset hiljada metara na nebu.', 'Novi Sad', 'uploads\\thumbnails\\3.png', 'uploads\\videos\\3.mp4', '2026-01-03 14:59:55.250');
INSERT INTO video_posts (id, owner_id, title, description, location, thumbnail_path, video_path, created_at) VALUES (4, 1, 'Spongebob Krusty Krab song on recorder', 'Song - Rake Hornpipe', 'Novi Sad', 'uploads\\thumbnails\\4.png', 'uploads\\videos\\4.mp4', '2026-01-03 15:00:59.689');
INSERT INTO video_posts (id, owner_id, title, description, location, thumbnail_path, video_path, created_at) VALUES (5, 1, 'In the Jungle, the mighty jungle...', 'OK I know that this is not the most original thing in the world but it is the whole song or that''s what I believe. Hope u lik it Bye, XokAs', 'Novi Sad', 'uploads\\thumbnails\\5.png', 'uploads\\videos\\5.mp4', '2026-01-03 15:02:01.817');
