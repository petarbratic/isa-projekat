...
INSERT INTO video_posts (id, owner_id, title, description, location, thumbnail_path, video_path, created_at, views) VALUES (3, 1, 'Snimak neba', 'Deset hiljada metara na nebu.', 'Novi Sad', 'uploads\\thumbnails\\3.png', 'uploads\\videos\\3.mp4', '2026-01-03 14:59:55.250',3);
INSERT INTO video_posts (id, owner_id, title, description, location, thumbnail_path, video_path, created_at, views) VALUES (4, 1, 'Spongebob Krusty Krab song on recorder', 'Song - Rake Hornpipe', 'Novi Sad', 'uploads\\thumbnails\\4.png', 'uploads\\videos\\4.mp4', '2026-01-03 15:00:59.689',5);
